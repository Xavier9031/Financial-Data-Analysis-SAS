...
data selc;
	set Porf;
	where rank_RET > 84 && rank_TD > 20 && rank_PE > 45 && rank_PB > 40 && rank_PS > 5 && rank_CD > 20 && rank_PV > 30 && rank_CDR > 30 && rank_SYD > 30 && rank_PR > 25 && rank_PP > 20 && rank_ATG > 75 ;
run;

data selc;
	set Porf;
	where rank_RET > 0 && rank_TD > 0 && rank_PE > 0 && rank_PB > 0 && rank_PS > 0 && rank_CD > 0 && rank_PV > 0 && rank_CDR > 0 && rank_SYD > 9 && rank_PR > 90 && rank_PP > 18 && rank_ATG > 16 ;
run;


data selc;
	set Porf;
	where rank_RET > 0 && rank_TD > 1 && rank_PE > 2 && rank_PB > 3 && rank_PS > 4 && rank_CD > 85 && rank_PV > 6 && rank_CDR > 67 && rank_SYD > 88 && rank_PR > 29 && rank_PP > 70 && rank_ATG > 31 ;
run;

data selc;
	set Porf;
	where rank_RET > 20 && rank_TD > 81 && rank_PE > 22 && rank_PB > 3 && rank_PS > 4 && rank_CD > 5 && rank_PV > 6 && rank_CDR > 7 && rank_SYD > 88 && rank_PR > 9 && rank_PP > 50 && rank_ATG > 11 ;
run;
